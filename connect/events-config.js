...
const PROJECT_ROLE_PROGRAM_MANAGER = 'program_manager';
const PROJECT_ROLE_SOLUTION_ARCHITECT = 'solution_architect';
const PROJECT_ROLE_PROJECT_MANAGER = 'project_manager';
const PROJECT_ROLE_MEMBER = 'member';
const PROJECT_ROLE_ACCOUNT_MANAGER = 'account_manager';
const PROJECT_ROLE_ACCOUNT_EXECUTIVE = 'account_executive';
...
const PROJECT_ROLE_RULES = {
  ...
  [PROJECT_ROLE_PROGRAM_MANAGER]: { role: 'program_manager' },
  [PROJECT_ROLE_SOLUTION_ARCHITECT]: { role: 'solution_architect' },
  [PROJECT_ROLE_PROJECT_MANAGER]: { role: 'project_manager' },
  [PROJECT_ROLE_ACCOUNT_MANAGER]: { role: 'account_manager' },
  [PROJECT_ROLE_ACCOUNT_EXECUTIVE]: { role: 'account_executive' },
  [PROJECT_ROLE_MEMBER]: {},
};
