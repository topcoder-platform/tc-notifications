 ...
 */
const getProject = projectId => M2m.getMachineToken(config.AUTH0_CLIENT_ID, config.AUTH0_CLIENT_SECRET)
  .then(token => request
 ...
 */
const getRoleMembers = roleId => M2m.getMachineToken(config.AUTH0_CLIENT_ID, config.AUTH0_CLIENT_SECRET)
  .then(token => request
 ...
 */
const getTopic = (topicId, logger) => M2m.getMachineToken(config.AUTH0_CLIENT_ID, config.AUTH0_CLIENT_SECRET)
  .then(token => request
